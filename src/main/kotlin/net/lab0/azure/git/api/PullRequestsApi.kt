...
import net.lab0.azure.git.model.definition.GitPullRequest
import net.lab0.azure.git.model.definition.enumeration.PullRequestStatus
...
interface PullRequestsApi {
  ...
  fun getPullRequestsByProject(
    ...
    @Query("searchCriteria.sourceRefName") searchCriteria_sourceRefName: String,
    @Query("searchCriteria.sourceRepositoryId") searchCriteria_sourceRepositoryId: String,
    @Query("searchCriteria.targetRefName") searchCriteria_targetRefName: String,
    @Query("searchCriteria.status") searchCriteria_status: PullRequestStatus,
    @Query("searchCriteria.reviewerId") searchCriteria_reviewerId: String,
    @Query("searchCriteria.creatorId") searchCriteria_creatorId: String,
    @Query("searchCriteria.repositoryId") searchCriteria_repositoryId: String,
    @Query("maxCommentLength") maxCommentLength: Int,
    @Query("${'$'}skip") skip: Int,
    @Query("${'$'}top") top: Int,
  ...
  fun create(
    ...
    @Path("repositoryId") repositoryId: String,
    @Path("project") project: String,
    @Query("supportsIterations") supportsIterations: Boolean,
    @Query("api-version") apiVersion: String = "5.0",
  ...
  fun getPullRequest(
    ...
    @Query("includeWorkItemRefs") includeWorkItemRefs: Boolean,
    @Query("api-version") apiVersion: String = "5.0"
  ): Call<JsonValue>
