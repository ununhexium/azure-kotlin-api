package net.lab0.azure.api.security.permissions
...
interface PermissionsApi {
  ...
  fun hasPermissions(
    ...
    @Query("alwaysAllowAdministrators") alwaysAllowAdministrators: Boolean? = null,
    @Query("delimiter") delimiter: String? = null,
