package net.lab0.azure.api.npm.recyclebinversions

import javax.json.JsonValue
import kotlin.String
import net.lab0.azure.model.definition.npm.NpmRecycleBinPackageVersionDetails
...
interface RecycleBinVersionsApi {
  ...
  fun getScopedPackageVersionMetadataFromRecycleBin(
  ...
  fun getPackageVersionMetadataFromRecycleBin(
    @Path("organization") organization: String,
    @Path("feedId") feedId: String,
