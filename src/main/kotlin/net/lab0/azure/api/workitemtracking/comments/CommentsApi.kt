package net.lab0.azure.api.workitemtracking.comments

import javax.json.JsonValue
import kotlin.Int
import kotlin.String
import net.lab0.azure.model.definition.enumeration.workitemtracking.CommentSortOrder
...
interface CommentsApi {
  ...
  fun getComments(
    ...
    @Query("fromRevision") fromRevision: Int? = null,
    @Query("${'$'}top") top: Int? = null,
    @Query("order") order: CommentSortOrder? = null,
