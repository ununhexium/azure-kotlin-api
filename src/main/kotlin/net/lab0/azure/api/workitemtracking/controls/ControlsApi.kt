package net.lab0.azure.api.workitemtracking.controls

import javax.json.JsonValue
import kotlin.String
import net.lab0.azure.model.definition.workitemtracking.Control
...
interface ControlsApi {
  ...
  fun moveControlToGroup(
    ...
    @Query("removeFromGroupId") removeFromGroupId: String? = null,
    @Query("api-version") apiVersion: String = "5.0-preview.1",
    @Header("Content-Type") contentType: String = "application/json",
    @Body body: Control
  ): Call<JsonValue>
