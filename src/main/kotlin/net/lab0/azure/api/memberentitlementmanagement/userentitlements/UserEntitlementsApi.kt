package net.lab0.azure.api.memberentitlementmanagement.userentitlements
...
import net.lab0.azure.model.definition.memberentitlementmanagement.UserEntitlement
...
interface UserEntitlementsApi {
  ...
  fun getUserEntitlements(
    ...
    @Query("sortOption") sortOption: String? = null,
  ...
  fun updateUserEntitlements(
    @Path("organization") organization: String,
    @Query("doNotSendInviteForNewUsers") doNotSendInviteForNewUsers: Boolean? = null,
    @Query("api-version") apiVersion: String = "5.0-preview.2",
