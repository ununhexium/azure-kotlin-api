package net.lab0.azure.api.serviceendpoint.endpoints

import javax.json.JsonValue
import kotlin.Boolean
import kotlin.String
import kotlin.collections.List
import net.lab0.azure.model.definition.serviceendpoint.ServiceEndpoint
...
interface EndpointsApi {
  ...
  fun getServiceEndpointsByNames(
    ...
    @Query("authSchemes") authSchemes: String? = null,
    @Query("includeFailed") includeFailed: Boolean? = null,
