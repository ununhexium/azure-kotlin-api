package net.lab0.azure.api.testplan.suiteentry
...
import net.lab0.azure.model.definition.testplan.SuiteEntryUpdateParams
...
interface SuiteEntryApi {
  ...
  fun getSuiteEntries(
    ...
    @Query("suiteEntryType") suiteEntryType: SuiteEntryTypes? = null,
