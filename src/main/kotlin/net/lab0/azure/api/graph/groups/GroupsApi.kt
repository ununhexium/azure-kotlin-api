package net.lab0.azure.api.graph.groups

import javax.json.JsonPatch
import javax.json.JsonValue
import kotlin.String
import net.lab0.azure.model.definition.graph.GraphGroupCreationContext
...
interface GroupsApi {
  ...
  fun listGroups(
    ...
    @Query("scopeDescriptor") scopeDescriptor: String? = null,
